...
for num_e in estimators:
    ...
    # Gradient Boosting
    clf_GB = GradientBoostingClassifier(n_estimators=num_e, random_state=42)
...
for i, metric in parameters:
    ...
    plt.plot(estimators, [x[i] for x in results_GB], 
             color='pink', lw=2, linestyle='dashed', label='boosting')
